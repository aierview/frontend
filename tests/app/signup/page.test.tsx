...
describe("Signup page", () => {
  ...
  it("should not show error message and redirect to signin if signup is successful", async () => {
    const pushMock = vi.fn();
    (useRouter as unknown as vi.Mock).mockReturnValue({ push: pushMock });
    const localSignupMock = vi.fn().mockResolvedValue(true);
    const mockRepo = {
      localSignup: localSignupMock,
      localSignin: vi.fn(),
    };
